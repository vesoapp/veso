...
# Build archives
dotnet publish --configuration Release --self-contained --runtime linux-x64 --output /dist/veso_${version}/ "-p:GenerateDocumentationFile=false;DebugSymbols=false;DebugType=none;UseAppHost=true"
