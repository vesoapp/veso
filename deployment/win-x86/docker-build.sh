...
# Build binary
dotnet publish --configuration Release --self-contained --runtime win-x86 --output /dist/veso_${version}/ "-p:GenerateDocumentationFile=false;DebugSymbols=false;DebugType=none;UseAppHost=true"
