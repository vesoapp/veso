...
function Install-TrayApp {
    ...
    if($Architecture -ne 'x64'){
        ...
        [Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12
        Invoke-WebRequest -Uri https://github.com/veso/veso-windows-tray/releases/latest/download/VesoTray.exe -UseBasicParsing -OutFile "$installLocation/VesoTray.exe" | Write-Verbose
    }
}
