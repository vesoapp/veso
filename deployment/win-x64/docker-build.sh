...
# Build binary
dotnet publish Jellyfin.Server --configuration Release --self-contained --runtime win-x64 --output /dist/veso_${version}/ "-p:GenerateDocumentationFile=false;DebugSymbols=false;DebugType=none;UseAppHost=true"
